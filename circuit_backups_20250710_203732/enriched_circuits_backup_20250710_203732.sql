...
--
-- Name: enriched_circuits; Type: TABLE; Schema: public; Owner: dsruser
--

CREATE TABLE public.enriched_circuits (
    id integer NOT NULL,
    network_name character varying(255) NOT NULL,
    device_tags text[],
    wan1_provider character varying(255),
    wan1_speed character varying(100),
    wan1_circuit_role character varying(50) DEFAULT 'Primary'::character varying,
    wan1_confirmed boolean DEFAULT false,
    wan2_provider character varying(255),
    wan2_speed character varying(100),
    wan2_circuit_role character varying(50) DEFAULT 'Secondary'::character varying,
    wan2_confirmed boolean DEFAULT false,
    last_updated timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    pushed_to_meraki boolean DEFAULT false,
    pushed_date timestamp without time zone,
    wan1_ip character varying(45),
    wan2_ip character varying(45),
    wan1_arin_org character varying(200),
    wan2_arin_org character varying(200)
);


ALTER TABLE public.enriched_circuits OWNER TO dsruser;

--
-- Name: enriched_circuits_id_seq; Type: SEQUENCE; Schema: public; Owner: dsruser
--

CREATE SEQUENCE public.enriched_circuits_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.enriched_circuits_id_seq OWNER TO dsruser;

--
-- Name: enriched_circuits_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dsruser
--

ALTER SEQUENCE public.enriched_circuits_id_seq OWNED BY public.enriched_circuits.id;


--
-- Name: enriched_circuits id; Type: DEFAULT; Schema: public; Owner: dsruser
--

ALTER TABLE ONLY public.enriched_circuits ALTER COLUMN id SET DEFAULT nextval('public.enriched_circuits_id_seq'::regclass);


--
-- Data for Name: enriched_circuits; Type: TABLE DATA; Schema: public; Owner: dsruser
--
...
--
-- Name: enriched_circuits_id_seq; Type: SEQUENCE SET; Schema: public; Owner: dsruser
--
...
--
-- Name: enriched_circuits enriched_circuits_network_name_key; Type: CONSTRAINT; Schema: public; Owner: dsruser
--

ALTER TABLE ONLY public.enriched_circuits
    ADD CONSTRAINT enriched_circuits_network_name_key UNIQUE (network_name);


--
-- Name: enriched_circuits enriched_circuits_pkey; Type: CONSTRAINT; Schema: public; Owner: dsruser
--

ALTER TABLE ONLY public.enriched_circuits
    ADD CONSTRAINT enriched_circuits_pkey PRIMARY KEY (id);


--
-- Name: idx_enriched_circuits_network_name_lower; Type: INDEX; Schema: public; Owner: dsruser
--

CREATE INDEX idx_enriched_circuits_network_name_lower ON public.enriched_circuits USING btree (lower((network_name)::text));
