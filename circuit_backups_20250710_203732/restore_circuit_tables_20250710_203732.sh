#!/bin/bash
# Emergency restore script created 20250710_203732
...
echo "Backup timestamp: 20250710_203732"
echo
...
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -f /usr/local/bin/circuit_backups_20250710_203732/enriched_circuits_backup_20250710_203732.sql

echo "Restoring circuits table..."
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -c "TRUNCATE TABLE circuits CASCADE;"
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -f /usr/local/bin/circuit_backups_20250710_203732/circuits_backup_20250710_203732.sql
