...
Generated on: 2025-07-10 10:44:37.327815
Rules: 56 -> 55
"""
...
def remove_duplicate_default_rule():
  ...
  },
  {
    ...
    "srcCidr": "VLAN(100).*",
    "destPort": "3478-3481",
    "destCidr": "13.107.64.0/18,52.112.0.0/14",
    "syslogEnabled": false
  },
  {
  ...
  },
  {
    ...
    "srcCidr": "VLAN(200).*",
    "destPort": "5228",
    "destCidr": "74.125.224.0/19,173.194.0.0/16,108.177.8.0/21,142.250.0.0/15",
    "syslogEnabled": false
  },
  {
  ...
  },
  {
    ...
    try:
        ...
        print(f"Rules count: 56 -> {len(updated_rules)}")
        return True
...
if __name__ == "__main__":
    ...
    print(f"Current rules: 56")
    print(f"After removal: 55")
