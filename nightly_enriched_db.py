...
def enrich_circuits(conn):
    ...
    if enriched_data:
        ...
        values = [
            (d['network_name'], d['wan1_provider'], d['wan1_speed'], d['wan1_circuit_role'], 
             d['wan1_confirmed'], d['wan2_provider'], d['wan2_speed'], 
             d['wan2_circuit_role'], d['wan2_confirmed'], d['last_updated'])
