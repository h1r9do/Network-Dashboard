#!/usr/bin/env python3
"""
ENHANCED Nightly Enriched Database Script with DSR-ARIN Preservation and WAN Flip Detection
This version preserves DSR data when ARIN providers match and handles WAN1/WAN2 flipping
"""
...
def enrich_circuits(conn):
    """ENHANCED: Main enrichment process with preservation logic and WAN flip detection"""
    cursor = conn.cursor()
...
def main():
    """Main function"""
    logger.info("=== Starting ENHANCED Nightly Enriched Database Script ===")
    logger.info("Features: DSR-ARIN preservation + WAN flip detection")
