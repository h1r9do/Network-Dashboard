#!/usr/bin/env python3
"""
Generate a script to update TST 01 DHCP configuration to match AZP 30
"""
...
def generate_update_script():
    """Generate Python script to update TST 01 DHCP configuration"""
...
if not API_KEY:
    print("Error: Please set MERAKI_DASHBOARD_API_KEY environment variable")
    sys.exit(1)
...
'''.format(timestamp=datetime.now().strftime('%Y-%m-%d %H:%M:%S'))
    ...
    with open('/usr/local/bin/Main/update_tst_01_dhcp_config.py', 'w') as f:
        f.write(script_content)
    
    print("Generated update script: update_tst_01_dhcp_config.py")
    print("To use this script:")
    print("1. Set your Meraki API key: export MERAKI_DASHBOARD_API_KEY='your-api-key'")
    print("2. Run: python3 update_tst_01_dhcp_config.py")
