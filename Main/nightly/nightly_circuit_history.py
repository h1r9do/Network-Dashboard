...
def update_circuit_history():
    ...
    # Import inside function to ensure Flask app context is available
    ...
    for change in changes:
        ...
        if not circuit:
            # Fallback to site_name only (for backward compatibility)
        ...
        if circuit:
            ...
            print(f"  ⚠️  Circuit not found in database: {change['site_name']} (Site ID: {change.get('site_id', 'N/A')})")
